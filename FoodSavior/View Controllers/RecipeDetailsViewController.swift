...
class RecipeDetailsViewController: UIViewController {
    ...
    func setupView() {
        let nutritionStackViewFacts: [String] = ["Calories: 2000", "Fat: 65", "Protein: Cow", "Carbs: Breactycctyccycgcyscascascacycgcyscascascascascascascascascascaccycytcycytcyd", "Sugar: Orange"]
